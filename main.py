...
if __name__ == "__main__":
    ...
    #features_df = extract_features.extract_features()
        ...
        #nn.predict("sample/vehicle.ogg",le,"trained_cnn.h5")
        ...
        # predicting using trained model with any test file in dataset
        #nn.predict("sample/new_file_chainsaw.wav",le,"trained_mlp.h5")
    ...
    nn.predict("sample/vehicle.ogg",LabelEncoder(),"trained_cnn.h5")